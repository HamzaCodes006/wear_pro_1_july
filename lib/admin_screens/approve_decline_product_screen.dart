...
class ApproveDeclineProductScreen extends StatefulWidget {
  ...
  const ApproveDeclineProductScreen({Key key}) : super(key: key);
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Container(
                        ...
                        child: FlatButton(
                          onPressed: (){Navigator.pushNamed(context, AdminDashboardScreen.id);},
                          child: Text(
                            'Rejected',
                    ...
                    SizedBox(
                      width: size.width *0.4,
                      child: RoundedButton(
                        buttonName: 'Accepted',onPress: (){Navigator.pushNamed(context, AdminSuccessScreen.id);},
                      ),
                    ),
                  ],
                ),
